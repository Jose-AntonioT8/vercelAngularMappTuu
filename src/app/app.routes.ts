...
export const routes: Routes = [
  ...
  { path: 'createdActivities', component: CreatedActivitiesComponent, canActivate: [authGuard] },
  { path: 'activityDetail/:id', component: ActivityDetailComponent, canActivate: [authGuard]},
  { path: 'updateActivity/:id', component: ActivitiesUpdateComponent, canActivate: [authGuard] },
